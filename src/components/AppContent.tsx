    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100">
        <div className="text-center p-8 bg-white rounded-lg shadow-lg">
          ...
          <h2 className="text-xl font-semibold text-gray-700">Loading application data...</h2>
          <p className="text-gray-500 mt-2">Please wait while we initialize the database.</p>
        </div>
      </div>
    );
  }
